...
public class TransactionEdit implements Writable {
  ...
  /**
   * Returns the transaction type. This is only populated for edits of type {@link State#INPROGRESS}.
   */
  ...
  public static TransactionEdit createAborted(long writePointer) {
    return new TransactionEdit(writePointer, 0L, State.ABORTED, 0L, null, 0L, false, null);
  }
